...
Sword::Sword(const sf::Texture & texture, sf::Vector2f * pickedPosition, const float & damage, const float & endurance, const float & attackSpeed, const float & range) :Pickable("Sword", texture, pickedPosition)
{
	this->damage = damage;
	this->endurance = endurance;
	this->attackSpeed = attackSpeed;
